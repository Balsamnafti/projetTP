 ...
 * @author balsa
 */
public class volmanagement extends javax.swing.JFrame {

    /**
     * Creates new form volmanagement
     */
    public volmanagement() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Num Vol", "Aeroport depart", "Aeroport arrivee", "Date depart ", "Date arrivee", "Heure depart", "Heure arrivee"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(volmanagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new volmanagement().setVisible(true);
            }
        });
    }
